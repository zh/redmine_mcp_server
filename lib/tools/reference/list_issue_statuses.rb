...
module RedmineMcpServer::Tools::Reference
  class ListIssueStatusesTool < RedmineMcpServer::Tools::BaseTool
    def name = 'list_issue_statuses'
    def description = 'list_issue_statuses - Read-only reference data from Redmine'
